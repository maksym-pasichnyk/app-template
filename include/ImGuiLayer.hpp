...
struct ImGuiLayer {
    ...
    ImGuiLayer(RenderContext& renderContext) {
        ...
        Init(renderContext, "#version 450");
        CreateDeviceObjects(renderContext);
    }
...
private:
    void Init(RenderContext& renderContext, const char* glsl_version) {
        ImGuiIO& io = ctx->IO;
...
//#endif
    ...
    bool CreateDeviceObjects(RenderContext& renderContext) {
        ...
        ShaderHandle          = renderContext.createShader(vertex_shader, fragment_shader);
